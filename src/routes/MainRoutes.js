...
const AppAuthorPublish = Loadable(lazy(() => import('views/application/publish')));
const AppAuthorPrint = Loadable(lazy(() => import('views/application/print')));
const AppAuthorBooks = Loadable(lazy(() => import('views/application/books')));
const AppAuthorPrintQueue = Loadable(lazy(() => import('views/application/print-queue')));
const AppAuthorBlogs = Loadable(lazy(() => import('views/application/blogs/ViewBlogs')));
const AppAuthorAddBlog = Loadable(lazy(() => import('views/application/blogs/AddBlog')));
const AppAuthors = Loadable(lazy(() => import('views/application/authors')));
const AppAuthorPayments = Loadable(lazy(() => import('views/application/authorPayments')));
const AppAuthorAllBooks = Loadable(lazy(() => import('views/application/allBooks')));
const AppAuthorAllBlogs = Loadable(lazy(() => import('views/application/allBlogs')));
const AppServiceFees = Loadable(lazy(() => import('views/application/serviceFees')));
const AppPublisherPrintQueue = Loadable(lazy(() => import('views/application/pubPrintQueue')));
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/publish',
            element: <AppAuthorPublish />
        },
        {
            path: '/print',
            element: <AppAuthorPrint />
        },
        {
            path: '/books',
            element: <AppAuthorBooks />
        },
        {
            path: '/print-queue',
            element: <AppAuthorPrintQueue />
        },
        {
            path: '/add-blog',
            element: <AppAuthorAddBlog />
        },
        {
            path: '/view-blogs',
            element: <AppAuthorBlogs />
        },
        {
            path: '/authors',
            element: <AppAuthors />
        },
        {
            ...
            element: <AppAuthorPayments />
        },
        {
            path: '/all-books',
            element: <AppAuthorAllBooks />
        },
        {
            path: '/all-blogs',
            element: <AppAuthorAllBlogs />
        },
        {
            path: '/services-fees',
            element: <AppServiceFees />
        },
        {
            path: '/pubPrint-queue',
            element: <AppPublisherPrintQueue />
        },
    ]
};
