...
const MenuCard = () => {
    ...
    const [currentRevenue, setCurrentRevenue] = useState(225)

    const currentPecentage = (currentRevenue / 300) * 100
    return (
        <CardStyle>
            <CardContent sx={{ p: 2 }}>
                <List sx={{ p: 0, m: 0 }}>
                    <ListItem alignItems="flex-start" disableGutters sx={{ p: 0 }}>
                        ...
                        <ListItemText
                            ...
                            secondary={<Typography variant="caption"> {currentRevenue}/300  USD</Typography>}
                        />
                    </ListItem>
                </List>
                <LinearProgressWithLabel value={currentPecentage} />
            </CardContent>
        </CardStyle>
    );
};
