...
const DashboardBlogCard = ({ id, color, name, image, description, offerPrice, salePrice, rating }) => {
                ...
                >
                    ...
                    <CardContent sx={{ p: 2 }}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sx={{ pt: '38px !important' }}>
                                <Stack direction="row" justifyContent="space-between" alignItems="center">
                                    <Grid container spacing={1}>
                                        <Stack direction="column" spacing={1}>
                                        <Typography variant="h6">Created 7 days ago</Typography>
                                            <Rating precision={0.5} name="size-small" value={productRating} size="small" readOnly />
                                            
                                        </Stack>
                                        
                                    </Grid>
                                    <Button variant="contained" sx={{ minWidth: 0, backgroundColor: 'red' }} onClick={addCart}>
