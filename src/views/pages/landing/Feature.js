                    ...
                    <Grid container spacing={2} sx={{ mb: 2 }}>
                        ...
                        <Grid item xs={12}>
                            <Typography variant="h2" component="div">
                                What UNIQUE BOOKS brings to you?
                            </Typography>
                        </Grid>
                        <Grid item xs={12}>
                            ...
                            <FadeInWhenVisible>
                                <SubCard>
                                    <Grid container justifyContent="center" spacing={2}>
                                        ...
                                        <Grid item xs={12}>
                                            <Typography variant="h3">PUBLISH BOOKS</Typography>
                                        </Grid>
                                        <Grid item xs={12}>
                                            <Typography variant="body2">
                            ...
                            <FadeInWhenVisible>
                                <SubCard>
                                    <Grid container justifyContent="center" spacing={2}>
                                        ...
                                        <Grid item xs={12}>
                                            <Typography variant="h3">PRINT BOOKS</Typography>
                                        </Grid>
                                        <Grid item xs={12}>
                                            <Typography variant="body2">
                                            Warm color palates and minimally designed interfaces make the user experience more
                            ...
                            <FadeInWhenVisible>
                                <SubCard>
                                    <Grid container justifyContent="center" spacing={2}>
                                        ...
                                        <Grid item xs={12}>
                                            <Typography variant="h3">BUY BOOKS</Typography>
                                        </Grid>
                                        <Grid item xs={12}>
                                            <Typography variant="body2">
                                            Warm color palates and minimally designed interfaces make the user experience more
