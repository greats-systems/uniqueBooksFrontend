...
import { getAuthors } from 'store/slices/author';
    ...
    const handleSearch = (event) => {
        ...
        if (newString) {
            const newRows = rows.filter((row) => {
                ...
                const properties = ['image', 'name', 'email', 'phone', 'totalRevenue', 'total_books', 'is_active'];
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="right">{row.total_books}</TableCell>
                                        <TableCell align="right">{row.totalRevenue}</TableCell>
                                        <TableCell align="center">
                                            {row.is_active ? <Chip label="Active" size="small" chipcolor="success" /> : <Chip label="InActive" size="small" chipcolor="orange" />}
                                            {/* {row.is_active  && <Chip label="InActive" size="small" chipcolor="orange" />} */}
